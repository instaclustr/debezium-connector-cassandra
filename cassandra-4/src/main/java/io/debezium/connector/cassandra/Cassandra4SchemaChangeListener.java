...
public class Cassandra4SchemaChangeListener extends AbstractSchemaChangeListener {
    ...
    public void onTableCreated(com.datastax.oss.driver.api.core.metadata.schema.TableMetadata tableMetadata) {
        ...
        Object cdc = tableMetadata.getOptions().getOrDefault("cdc", "false");

        if (cdc.toString().equals("true")) {
        ...
        try {
            ...
            UUID uuid = UUID.nameUUIDFromBytes(ArrayUtils.addAll(tableMetadata.getKeyspace().toString().getBytes(),
                    tableMetadata.getName().toString().getBytes()));
            ...
            Keyspace.open(metadata.keyspace).initCf(TableMetadataRef.forOfflineTools(metadata), false);
    ...
    public void onTableUpdated(final com.datastax.oss.driver.api.core.metadata.schema.TableMetadata newTableMetadata,
        ...
        Object newCdcObject = newTableMetadata.getOptions().getOrDefault("cdc", "false");
        Object oldCdcObject = newTableMetadata.getOptions().getOrDefault("cdc", "false");
